...
?>
    ...
    <?php echo CHtml::link(CHtml::image($imageUrl.'icon1.png','image1',array('id'=>'headImage1')),array('/article/show', 'id'=>2)); ?>
    <?php echo CHtml::link(CHtml::image($imageUrl.'icon2.png','image2',array('id'=>'headImage2')),array('/article/show', 'id'=>3)); ?>
    <?php echo CHtml::link(CHtml::image($imageUrl.'icon3.png','image3',array('id'=>'headImage3')),array('/article/show', 'id'=>4)); ?>
    <?php echo CHtml::link(CHtml::image($imageUrl.'icon4.png','image4',array('id'=>'headImage4')),array('/article/show', 'id'=>5)); ?>
